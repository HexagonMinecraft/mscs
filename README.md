...
* Duplicity    - Allows the script to send backups to AWS S3.
...
installed by running:
    ...
    sudo apt-get install default-jre perl libjson-perl python make wget rdiff-backup duplicity python-boto socat iptables
